...
def Api_connect():
    Api_Id="AIzaSyB53uTA0X-vMXMOrw3dIuf4KcclLw49ZXY"
    ...
    for video_id in video_ids:
        ...
        for item in response["items"]:
            data=dict(channel_Name=item['snippet']['channelTitle'],
                ...
                Likes=item['statistics'].get('viewCount'),
                Comments=item['statistics']['likeCount'],
...
def channel_details(channel_id):
    ...
    coll1.insert_one({"channel_information":ch_details,"playlist_information":pl_details,
                      "video_information":vi_details,"comment_information":vi_details})
...
def comments_table():
    ...
    for index,row in df3.iterrows():
        insert_query='''insert into videos(Comment_Id,
                                            Video_Id,
                                            Comment_Text,
                                            Comment_Author,
                                            Comment_Published
...
if question=="1. ALL THE VIDEOS AND THE CHANNEL NAME":
    ...
    for index,row in df9.iterrows():
        ...
        average_duration=row["avaerageduration"]
